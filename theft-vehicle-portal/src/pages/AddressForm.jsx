            ...
            <div style={{ width: "100%" }}>
                ...
                <div className="reset_frm_btn">
                    <Button
                        ...
                        type="primary"
                        size="sm"
                        onClick={handleAddUpnam}
                    >
                        सहेजे
                    </Button>
                    <Button style={{ marginTop: "32px" }} type="primary" size="sm">
                        रिक्त करें
                    </Button>
                </div>
                <Table
                    ...
                    <div className="main_container_forms_drawer">
                        <div className="form1">
                            <Stack spacing={2}>
                                ...
                                <FormControl>
                                    ...
                                    <Input
                                        name="tehsilBlockMandal"
                                        value={formData.tehsilBlockMandal}
                                        onChange={handleInputChange}
                                        placeholder="तहसील / ब्लॉक / मंडल"
                                        size="sm"
                                    />
                        ...
                        <div className="form1">
                            <Stack spacing={2}>
                                ...
                                <FormControl isRequired>
                                    <FormLabel>पुलिस स्टेशन</FormLabel>
                                    <Select
                                        name="policeStation"
                                        value={formData.policeStation}
                                        onChange={handleInputChange}
